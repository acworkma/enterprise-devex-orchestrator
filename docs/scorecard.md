...
|---|---|---|
| Working agent code | ✅ | `src/orchestrator/` |
| AGENTS.md | ✅ | `AGENTS.md` |
| mcp.json | ✅ | `mcp.json` |
| README.md | ✅ | `README.md` |
| Architecture diagram | ✅ | `docs/architecture.md` (3 Mermaid diagrams) |
| Security documentation | ✅ | `docs/security.md` |
| RAI considerations | ✅ | `docs/rai-notes.md` |
| Demo script | ✅ | `docs/demo-script.md` |
| Deployment guide | ✅ | `docs/deployment.md` |
| CI/CD pipeline | ✅ | Generated by `CICDGenerator` — OIDC, CodeQL, Dependabot |
| Unit tests | ✅ | `tests/` — 152 test cases across 4 test modules |
| IaC templates | ✅ | `infra/bicep/` — static reference; generated dynamically |
