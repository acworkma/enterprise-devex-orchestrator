...
applied to all Azure resources in the **agent365** project.
...
### Resource Names for `agent365` (dev / eastus2)

| Resource Type | Generated Name |
|---|---|
| rg | `rg-agent365-dev-eus2` |
| law | `law-agent365-dev-eus2` |
| id | `id-agent365-dev-eus2` |
| kv | `kv-agent365-dev-eus2` |
| cr | `cragent365deveus2` |
| ca | `ca-agent365-dev-eus2` |
| cae | `cae-agent365-dev-eus2` |
| st | `stagent365deveus2` |
