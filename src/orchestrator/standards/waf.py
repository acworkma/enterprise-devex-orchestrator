    ...
    def _evaluate_principle(  # noqa: C901, PLR0911, PLR0912
        ...
        *,
        ...
        if pid == "SEC-04":
            ...
            return (
                covered,
                "RBAC roles scoped to resource groups with least-privilege assignments" if covered else "RBAC not configured",
        ...
        if pid == "OPS-01":
            ...
            return (
                covered,
                "Log Analytics workspace with diagnostic settings for all resources" if covered else "No centralized logging",
